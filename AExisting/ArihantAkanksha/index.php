...
<title>Arihant Akanksha - New real estate project with 2/3/4 BHK flats in Palaspe Panvel City</title>
<meta name="description" content="Arihant Akanksha is a modern real estate project offering 2/3/4 BHK apartments in Palaspe in Panvel City with a launch price of ? 5666 per square foot. Latest amenities and with an ideal location which is close to a the railway station, hospital, markets, the new international airport site and more">
<meta name="keywords" content="arihant akanksha, arihant superstructures limited, asl, panvel palaspe, bhk flats">
...
margin-left: 9px;
margin-top: 9px;
background-color: #FEFEFE; margin-bottom: 15px;">
    ...
    padding-bottom: 8px;
			        ...
			        <div id="inner" style="width:601px;">
						...
						<div id="image2">
						<a id="elevation" class="fancybox" rel="group" href="images/elevation.png"><img src="images/elevation.png" style="float: left;padding-left: 7px;padding-top: 8px;
...
clear: both;">
	<div id="text2" style="font-size: 11px;text-align: center;border-bottom: 1px solid grey;">
					...
					<div style="list-style-image:url(images/bullet.png); font-size: 13px;line-height: 23px;text-align: left;width: 50%;height: 130px;float: left; width:50%;  font-family: font-family:Arial, Helvetica, sans-serif; color: #707070;"> 
    ...
    <li>FRP doors for bathroom</li>
			...
			<div style="list-style-image:url(images/bullet.png); float:right;font-size: 13px;line-height: 21px;text-align: left; padding-top:0px; width:50%;width:50%;  font-family: font-family:Arial, Helvetica, sans-serif;">
...
margin-left: 9px; font-family: font-family:Arial, Helvetica, sans-serif;">A PREMIUM PRODUCT FROM THE HOUSE OF <b>ARIHANT</b> A TRUSTED AND RELIABLE NAME</div>
			<div id="box3" style:" background-color:white; ">
			 ...
			 <a id="amodini" class="fancybox" rel="group" href="images/amodini.jpg">	<img src="images/amodini.jpg" style="float:left;padding-top: 17px;padding-bottom: 14px;padding-left: 10px;padding-right: 9px;" ></a></div>
			 <div>
			 	<a id="amisha" class="fancybox" rel="group" href="images/amisha.jpg"> <img src="images/amisha.jpg" style="float:left; padding-top: 0px;padding-right: 10px;padding-top: 17px;" ></a></div>
			 <div>
			 	<a id="anmol" class="fancybox" rel="group" href="images/anmol.jpg"><img src="images/anmol.jpg" style="float:left;padding-top: 17px;"  ></a></div>
			 </div>
			<div><p style="text-align:center;clear: both; font-family: font-family:Arial, Helvetica, sans-serif; font-size: 13px;
